...
import { ActivityIndicator, StatusBar, SafeAreaView, Platform } from 'react-native';
      ...
      <PaperProvider>
        <NavigationContainer theme={storeMode === 'dark' ? DarkTheme : DefaultTheme}>
          <GestureHandlerRootView style={{ flex: 1 }}>
            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: '#005eb8', paddingTop: Platform.OS === 'android' ? statusBarHeight : 0 }}>
              <RootStackNavigator />
              <FAB
                style={{
                  position: 'absolute',
